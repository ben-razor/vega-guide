...
The script you see to the right is GraphQL.

[GraphQL](https://graphql.org/) is a concise language for making queries.
...
You can use GraphQL to access aspect of Vega Protocol. So you have great power.
